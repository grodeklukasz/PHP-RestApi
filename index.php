...
<html>
    ...
    <body>
        ...
        <p>
        <ul>
            <li>../api/product/read.php</li>
            <li>../api/product/search.php?s=shirt</li>
            <li>../api/product/read_one.php?id=60</li>
            <li>../api/category/read.php</li>
        </ul>
        </p>
        <h1>Database settings</h1>
        <h4>api/config/database.php</h4>
        
        <h3>Create Categories Table</h3>
        <p>
        <pre>
        ...
        <h3>Data for Table Categories</h3>
        <p>
        <pre>
